...
const hedaing3 = document.getElementsByTagName('h3');
for (const h3 of hedaing3) {
...
imageContainer.addEventListener('mouseenter', function () {
    ...
    newimage.setAttribute('src', 'images/shoes/shoe-1.png');
...
touchContainer.addEventListener('dblclick', function () {
    console.log('touch');
    touchContainer.style.backgroundColor = 'goldenrod';
})